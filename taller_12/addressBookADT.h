#ifndef ADDRESSBOOKADT_H
#define ADDRESSBOOKADT_H
#include <stdio.h>
#include <stdlib.h>
...
/* Almacena un nuevo grupo de contactos. Si el grupo existe, no hace nada y retorna 0.
...
** Retorna 1 si se pudo crear el grupo
*/
